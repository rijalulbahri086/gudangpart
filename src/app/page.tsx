...
export default function Dashboard() {
  ...
  // 🟢 LOGIKA FILTERING GANDA (SEARCH TEKS + PERUNTUKAN MESIN + LOW STOCK)
  const filteredItems = items.filter((item) => {
    ...
    // 2. Logika Filter Peruntukan Mesin
    const matchesMachine =
      selectedMachine === 'ALL' || item.machine_target === selectedMachine;

    // 3. Logika Filter Stok Menipis
    ...
    <div className="min-h-screen bg-slate-50 p-4 md:p-8">
      ...
      <header className="max-w-7xl mx-auto mb-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        <div className="flex flex-wrap items-center gap-2">
          {/* USER INFO / TOMBOL LOGIN (TETAP DI HP & DESKTOP) */}
          {currentUser ? (
          ...
          {/* TOMBOL REFRESH (TETAP DI HP & DESKTOP) */}
          <button
          ...
          {/* 🟢 TOMBOL-TOMBOL NAVIGASI DI-HIDE DI HP (hidden md:flex) */}
      ...
      {/* 🟢 KARTU RINGKASAN LOW STOCK ALERT (MUNCUL DI HP & PC) */}
      ...
      {/* 🟢 SEARCH BAR PINTAR, DROPDOWN MESIN, & TOGGLE FILTER LOW STOCK */}
      <div className="max-w-7xl mx-auto mb-8 flex flex-col lg:flex-row gap-3">
        ...
        <div className="flex flex-wrap sm:flex-nowrap gap-3">
          ...
          {/* TOMBOL TOGGLE FILTER STOK MENIPIS */}
          <button
            ...
            title="Tampilkan barang yang stoknya menipis saja"
          >
      ...
      {/* 🟢 DRAWER MENU MOBILE (SLIDE-OVER HAMBURGER MENU KHUSUS HP) */}
      {mobileMenuOpen && (
        <div className="fixed inset-0 z-50 flex justify-end bg-black/50 backdrop-blur-sm md:hidden">
          <div className="w-4/5 max-w-sm bg-white h-full p-6 flex flex-col justify-between shadow-2xl animate-in slide-in-from-right duration-200">
            <div>
